...
import InteractiveImageCanvas from "./compo/InteractiveImageCanvas";
import React, { useState } from "react";
import Errordevice from "./compo/Errordevice"
function App() {
  const [Widthsvg, Setwidthsvg] = useState(["28"]);
    ...
    <DndProvider backend={HTML5Backend}>
      <div className="App">
        <div className="w-full flex flex-col h-screen   select-none">
          {/* NAV-BAR  */}
          <div
            className="w-full h-14 bg-primary justify-between	   drop-shadow-none sm:drop-shadow-md  p-6 flex items-center z-40"
            id="Navbar-bg"
          >
            <div>
              <h1 className=" blur-sm md:blur-none  text-white font-bold font-sans ml-11 text-base select-none sticky">
                Creative Collector
              </h1>
            </div>
            <div className="  hidden sm:flex   text-white flex items-center justify-evenly	gap-2">
              <h1 className="font-bold">Used Tools : </h1>
              <svg
          ...
          {/* Show InteractiveImageCanvas on large screens and hide on mobile */}
